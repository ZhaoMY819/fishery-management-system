	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="账号余额" prop="zhanghaoyue" >
					<el-input-number v-model="ruleForm.zhanghaoyue" placeholder="账号余额" :disabled="ro.zhanghaoyue"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="账号余额" prop="zhanghaoyue" >
					<el-input v-model="ruleForm.zhanghaoyue" placeholder="账号余额" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-else-if="ruleForm.huiyuandengji" label="会员等级" prop="huiyuandengji" >
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.zhanghaoyue = Number('0'); 					this.ruleForm.huiyuanzhekou = Number('1'); 				}
				// 获取用户信息
				this.$http({
