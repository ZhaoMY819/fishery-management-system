<template>
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="账号余额" prop="zhanghaoyue">
				<el-input-number v-model="ruleForm.zhanghaoyue" placeholder="账号余额" :disabled="true ||ro.zhanghaoyue"></el-input-number>
			</el-form-item>
			<el-form-item class="add-item" label="会员等级" prop="huiyuandengji">
			...
			<el-form-item class="add-item" label="会员折扣" prop="huiyuanzhekou">
				<el-input-number v-model="ruleForm.huiyuanzhekou" placeholder="会员折扣" :disabled="true ||ro.huiyuanzhekou"></el-input-number>
			</el-form-item>
