	...
	<div class="main-containers">
		<div class="body-containers">
			<div class="top-container">
				<!-- info -->
				<div class="top_title">
					<span @click="goMenu('/index/home')">基于Spring Boot的钓手渔场管理系统设计与实现</span>
				</div>
		...
		async getSession() {
			await this.$http.get(`${localStorage.getItem('UserTableName')}/session`, {emulateJSON: true}).then(async res => {
				if (res.data.code == 0) {
					...
					if(localStorage.getItem('UserTableName')== 'yuchangzhu') {
						localStorage.setItem('username', res.data.data.yuchangzhuzhanghao);
					}
