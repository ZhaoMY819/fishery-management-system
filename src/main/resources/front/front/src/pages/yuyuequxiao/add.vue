	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item" label="总时长" prop="zongshizhang">
				<el-input v-model.number="ruleForm.zongshizhang" 
					placeholder="总时长" clearable :disabled=" false  ||ro.zongshizhang"></el-input>
			</el-form-item>
			<el-form-item class="add-item" label="总费用" prop="zongfeiyong">
				<el-input-number v-model="ruleForm.zongfeiyong" placeholder="总费用" :disabled=" false ||ro.zongfeiyong"></el-input-number>
			</el-form-item>
