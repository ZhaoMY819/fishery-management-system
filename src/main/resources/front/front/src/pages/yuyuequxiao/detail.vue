		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('yuyuequxiao','修改')" @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('yuyuequxiao','删除')" @click="delClick">删除</el-button>
						<el-button class="auditBtn" v-if="btnAuth('yuyuequxiao','审核')" @click="onSH" type="warning">回复</el-button>
					</div>
				</div>
			</div>
			...
			<el-tabs class="detail-tabs" v-model="activeName" type="border-card" v-if="tabsNum>0" >
				<el-tab-pane label="取消原因" name="first">
					<div class="ql-snow ql-editor" v-html="detail.quxiaoyuanyin"></div>
				</el-tab-pane>
			</el-tabs>
