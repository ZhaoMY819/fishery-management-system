		...
		<div class="list-preview">
			<el-form :inline="true" :model="formSearch" class="list-form-pv">
				<el-form-item class="list-item">
					...
					<el-input v-model="formSearch.yuchangzhuzhanghao" placeholder="渔场主账号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
				</el-form-item>
				<el-form-item class="list-item">
				...
				<el-button class="list-add-btn" v-if="btnAuth('yuchangzhu','新增')" type="primary" @click="add('/index/yuchangzhuAdd')">
			...
			<div class="list">
				<div class="list5">
					<div v-for="(item,index) in dataList" :key="index" class="list-item" @click.stop="toDetail(item)">
						...
						<div class="infoBox">
							<div class="name">{{item.yuchangzhuzhanghao}}</div>
							<div class="name">{{item.fuzeren}}</div>
	...
	export default {
		...
		methods: {
			...
			getList(page, fenlei, ref = '') {
				...
				let searchWhere = {};
				if (this.formSearch.yuchangzhuzhanghao != '') searchWhere.yuchangzhuzhanghao = '%' + this.formSearch.yuchangzhuzhanghao + '%';
				if (this.formSearch.fuzeren != '') searchWhere.fuzeren = '%' + this.formSearch.fuzeren + '%';
				let user = JSON.parse(localStorage.getItem('sessionForm'))
				if (this.sortType) searchWhere.sort = this.sortType
				if (this.sortOrder) searchWhere.order = this.sortOrder
				this.$http.get(`yuchangzhu/${this.centerType?'page':'list'}`, {params: Object.assign(params, searchWhere)}).then(res => {
					if (res.data.code == 0) {
			...
			toDetail(item) {
				...
				this.$router.push({path: '/index/yuchangzhuDetail', query: params});
			},
